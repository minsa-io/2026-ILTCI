...
**Automation Helpers**
- Build reusable helper functions to speed up recurring workflows.

**Report Drafting**
- Draft new reports by summarizing and restructuring content from existing documents.

**Model & Process Improvement**
- Apply code-driven changes to models and processes to unlock new functionality, improve performance, and reduce manual work.
